      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-16 border-b border-white/5 pb-12">
            {[
                ...
                { name: "Garantía 14 días", icon: (
                  <svg className="w-5 h-5 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M16 15v-1a4 4 0 00-4-4H8m0 0l3 3m-3-3l3-3m9 14V5a2 2 0 00-2-2H6a2 2 0 00-2 2v16l4-2 4 2 4-2 4 2z" /></svg>
                )},
                ...
                { name: "Sello Vegano", icon: (
                  <svg className="w-5 h-5 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-7.714 2.143L11 21l-2.286-6.857L1 12l7.714-2.143L11 3z" /></svg>
                )}
            ].map((item, idx) => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-6">
              Supermercado 100% vegetal operado por <strong>Jepco Consultors SL</strong>. Logística JIT para máxima frescura en alimentación ética y sostenible.
            </p>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-center text-slate-500 text-xs">
          <div className="text-left">
            ...
            <p>Operado por Jepco Consultors SL · NIF: B66150434 · Tel: +34 931 456 580 · Avda. Salvador Espriu 38, 08181 Sentmenat (Barcelona)</p>
          </div>
          <div className="flex gap-4 items-center">
             <div className="flex items-center gap-1.5 text-emerald-500/80 font-bold border border-emerald-500/20 bg-emerald-500/5 px-3 py-1.5 rounded-full">
                ...
                <span>Sello JIT: Logística 24-48h</span>
             </div>
          </div>
        </div>
      </div>
